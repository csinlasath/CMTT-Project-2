...
export default () => (
    <Layout>
        <CardBackground>
            ...
            <h5 id="description" className="text-success">Description</h5>
            ...
            <h5 id="Motivation" className="text-success">Motivation</h5>
            ...
            <h5 id="Result" className="text-success">Results</h5>
